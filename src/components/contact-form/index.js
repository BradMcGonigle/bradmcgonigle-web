      ...
      <React.Fragment>
        <OverlappedSection className={`has-background-${sectionColor} has-text-centered`}>
          <Container>
            ...
            <Heading subtitle className="has-text-light">Or really just anything at all {isFormSubmitted}.</Heading>
          </Container>
        </OverlappedSection>
            ...
            <Columns centered>
              <Columns.Column size="half">
                <OverlappingContent>
                  {isFormSubmitted ?
                    <div>
                      <Heading size={3} className="has-text-weight-light">Thanks for getting in touch!</Heading>
                      <Heading subtitle size={4}>We'll talk soon even if it's just to say hi.</Heading>
                    </div>
                  :
                    <form
                    ...
                    >
                      <div className="field" hidden>
                        <p>
                          <label>Don’t fill this out if you're human: <input type="hidden" name="form-name" value="contact" /></label>
                        </p>
                      </div>
                      <div className="field" hidden>
                        <p>
                      ...
                      <div className="field">
                        <p className="control">
                          <input className="input" placeholder="Email" name="email" type="email" value={email} onChange={this.handleChange} />
                        </p>
                      </div>
                      <div className="field">
                        <div className="control">
                          <textarea className="textarea" placeholder="Message" name="message" value={message} onChange={this.handleChange}></textarea>
                        </div>
                      </div>
                      <div className="field">
                        <div className="control">
