    ...
    <Container fluid>
      <Columns className="content">
        ...
        >
          ...
          <p className="is-size-6 has-text-weight-light margin-bottom-0">
            &copy; {new Date().getFullYear()}. All rights reserved.
          </p>
          <p className="is-size-6 has-text-weight-light">
            Built with <a href="http://www.gatsbyjs.org">Gatsby</a> and{' '}
            <a href="http://bulma.io">Bulma</a> running on{' '}
